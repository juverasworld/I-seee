...
import stripe3 from "../public/images/stripe3.png";
...
const Form = () => {
  return (
    ...
    <div className="bg-white shadow-md rounded pt-6 pb-8 mb-4 md:px-12 px-5 mx-5 sm:w-1/2 md:w-1/3">
      <p className="pt-3 ">
            <Image width={400} height={300} src={stripe3} alt="" className="pb-3" />
          </p>
          <h2 className="font-bold text-center my-5 text-2xl"> Interact</h2>
